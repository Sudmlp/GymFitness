...
<body>
    ...
    <!-- Main Content -->
    <div class="main">
        <h1 class="text-center">Viewing Trainers Data</h1>
        ...
        <div class="table-container">
            <table class="table table-bordered table-striped">
                ...
                <a href="trainer_form.jsp" class="btn btn-primary mb-3">Add Trainer</a>
                <tbody>
                    <%
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            id = rs.getInt("id"); // Assuming "id" is the primary key
                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                <!-- Delete Button Form -->
                                <form action="delete_trainer.jsp" method="POST" onsubmit="return confirm('Are you sure you want to delete this trainer?');">
